...
worker_run_frontend() {
  ...
  local variable_name
  for variable_name in DART_SDK BUILD_RUNNER_ACCELERATOR_METRICS BUILD_RUNNER_ACCELERATOR_READ_SHARED_MEMORY BUILD_RUNNER_ACCELERATOR_READ_SHARED_MEMORY_CAPACITY BUILD_RUNNER_ACCELERATOR_WORKER_AOT BUILD_RUNNER_ACCELERATOR_WORKER_AOT_PATH BUILD_RUNNER_ACCELERATOR_WORKER_AOT_BACKGROUND_LOCK BUILD_RUNNER_ACCELERATOR_WORKER_KERNEL; do
