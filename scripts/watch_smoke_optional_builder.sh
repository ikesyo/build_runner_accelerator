...
fail() {
  printf 'optional-builder-watch: FAIL: %s\n' "$*" >&2
  verification_report_watch_timeout "optional-builder-watch" "$workspace_root" "$stock_log" "$stock_pid" "$rust_log" "$rust_pid"
...
wait_for_path "$stock_dir/lib/input.optional.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.final.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.primary.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.glob.txt" "$stock_pid"
wait_for_path "$rust_dir/lib/input.optional.txt" "$rust_pid"
wait_for_path "$rust_dir/lib/input.final.txt" "$rust_pid"
wait_for_path "$rust_dir/lib/input.primary.txt" "$rust_pid"
wait_for_path "$rust_dir/lib/input.glob.txt" "$rust_pid"
assert_same_file "$stock_dir/lib/input.optional.txt" "$rust_dir/lib/input.optional.txt"
assert_same_file "$stock_dir/lib/input.final.txt" "$rust_dir/lib/input.final.txt"
...
wait_for_text "$rust_dir/lib/input.optional.txt" 'changed optional' "$rust_pid"
wait_for_text "$stock_dir/lib/input.final.txt" 'changed optional' "$stock_pid"
wait_for_text "$rust_dir/lib/input.final.txt" 'changed optional' "$rust_pid"
wait_for_text "$stock_dir/lib/input.primary.txt" 'changed optional' "$stock_pid"
wait_for_text "$rust_dir/lib/input.primary.txt" 'changed optional' "$rust_pid"
wait_for_text "$stock_dir/lib/input.glob.txt" 'changed optional' "$stock_pid"
wait_for_text "$rust_dir/lib/input.glob.txt" 'changed optional' "$rust_pid"
assert_same_file "$stock_dir/lib/input.optional.txt" "$rust_dir/lib/input.optional.txt"
assert_same_file "$stock_dir/lib/input.final.txt" "$rust_dir/lib/input.final.txt"
assert_same_file "$stock_dir/lib/input.primary.txt" "$rust_dir/lib/input.primary.txt"
assert_same_file "$stock_dir/lib/input.glob.txt" "$rust_dir/lib/input.glob.txt"
...
rm -f -- \
  "$stock_dir/lib/input.optional.txt" "$stock_dir/lib/input.final.txt" \
  "$stock_dir/lib/input.primary.txt" "$stock_dir/lib/input.glob.txt" \
  "$rust_dir/lib/input.optional.txt" "$rust_dir/lib/input.final.txt" \
  "$rust_dir/lib/input.primary.txt" "$rust_dir/lib/input.glob.txt"
wait_for_path "$stock_dir/lib/input.optional.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.final.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.primary.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/input.glob.txt" "$stock_pid"
...
wait_for_path "$stock_dir/lib/renamed.optional.txt" "$stock_pid"
wait_for_path "$stock_dir/lib/renamed.primary.txt" "$stock_pid"
wait_for_path "$rust_dir/lib/renamed.optional.txt" "$rust_pid"
wait_for_path "$rust_dir/lib/renamed.primary.txt" "$rust_pid"
wait_for_absent "$stock_dir/lib/input.optional.txt" "$stock_pid"
wait_for_absent "$stock_dir/lib/input.final.txt" "$stock_pid"
wait_for_absent "$stock_dir/lib/input.primary.txt" "$stock_pid"
wait_for_absent "$stock_dir/lib/input.glob.txt" "$stock_pid"
wait_for_absent "$rust_dir/lib/input.optional.txt" "$rust_pid"
wait_for_absent "$rust_dir/lib/input.final.txt" "$rust_pid"
wait_for_absent "$rust_dir/lib/input.primary.txt" "$rust_pid"
wait_for_absent "$rust_dir/lib/input.glob.txt" "$rust_pid"
assert_same_file "$stock_dir/lib/renamed.optional.txt" "$rust_dir/lib/renamed.optional.txt"
assert_same_file "$stock_dir/lib/renamed.primary.txt" "$rust_dir/lib/renamed.primary.txt"
...
printf 'optional-builder-watch: demand=yes output-delete=yes rename=yes\n'
