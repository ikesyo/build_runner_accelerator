...
bool operator ==(Object other) {
  final _this = this as SerializableUser;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SerializableUser&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.displayName, _this.displayName) || other.displayName == _this.displayName));
}
...
String toString() {
  final _this = this as SerializableUser;
  return 'SerializableUser(id: ${_this.id}, displayName: ${_this.displayName})';
}
